---
title: 关于
description: 关于 Tony Law —— 美股投资者、期权交易者、AI 全栈工程师、中国国职滑雪教练。
slug: about
---

# 关于我

我是 Tony Law，一名美股投资者、期权交易者、AI 全栈工程师，也是中国国职滑雪教练。
同时长期做金融科技、跨境支付、支付网关和 AI 金融工具，
做过 Web、移动端、后端 API、金融产品流程、监控系统和内部平台。

我最近的工作主要在软件工程和市场研究的交叉处：期权研究工具、AI 美股分析、自动化发布流程，
以及面向金融业务的产品基础设施。我更关心能在真实环境里跑起来的系统：边界清楚、可观测、
能稳定交付，并且能把复杂金融决策变得更容易理解。

独立做项目之前，我参与过跨境金融产品、支付基础设施和研发管理系统建设。这些经历让我形成了一个
很朴素的判断：好的工程不只是在 demo 里好看，也要经得住合规、运营、区域发布和真实用户压力。

## 工作经历

### 独立项目

围绕金融科技产品和 AI 辅助金融工作流持续做全栈工程实践。

- **负责模块：** THETA 期权风险工具、AI US Stock Analyst、美股文章自动化发布、Hono/Prisma
  产品栈、Python 市场工作流脚本。
- **主要职责：** 设计金融产品流程，搭建类型安全的前后端契约，维护自动化流水线，并系统复盘
  跨境支付、KYC/AML、结算和 Serverless 架构。

### [XTransfer](https://www.xtransfer.com/)

跨境金融产品方向的资深前端工程师。

- **负责模块：** 跨境外汇、资金、授信、账户流程，中国大陆与香港站点集成，共用业务组件，
  i18n 脚手架，Sentry 仪表盘和业务异常报告。
- **主要职责：** 负责合规敏感金融流程的 Web 与 React Native 架构；拆解需求、编写技术方案，
  协同后端、产品和运营完成交付；做代码审查和 API 集成；优化 LCP、可访问性和监控体系；并通过
  架构讨论、代码审查和 AI 辅助编码实践带动团队交付。

### [Lalamove](https://www.lalamove.com/)

支付网关和支付管理系统方向的高级软件工程师。

- **负责模块：** 支付网关、支付渠道接入、多区域多币种支付服务、支付管理后台、监控 SDK、
  H5/NPM/SDK 分发模式，以及覆盖 PC、移动端和小程序的统一收银台。
- **主要职责：** 扩展 Java/Spring Boot 后端服务；将旧支付管理后台从 Vue 重构到 React；
  建立仓库、构建、发布和部署基础；提升支付链路的可观测性和合规运营能力；通过可复用收银台和
  SDK 模式降低业务接入成本。
...
- **负责模块：** KA 客户定制需求、后端 API、数据模型、业务模块和内部管理工具。
- **主要职责：** 交付 Go 后端能力和配套前端页面，协同产品、设计和运营推进完整功能上线；
  在性能、可维护性和交付节奏之间做平衡，并通过内部工具减少人工运营工作。
...
- **金融产品系统** —— 跨境支付、外汇、账户流程、授信/资金产品、支付网关运营和合规敏感界面。
- **全栈产品交付** —— 前端架构、后端 API、可复用业务组件、类型安全契约、CI/CD 和生产运维。
- **监控与可靠性** —— Sentry 仪表盘、业务异常报告、运行检查和关键业务链路反馈机制。
- **AI 辅助工作流** —— LLM 研究、报告生成、自动化脚本、提示词实践和可人工复核的发布流水线。
